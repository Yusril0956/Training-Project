...
class TrainingController extends Controller
{
    ...
    {
        $jenis = JenisTraining::where('code', 'GK')->firstOrFail();

        // Eager-load relasi yang benar dan eksekusi query-nya
        $trainings = Training::where('jenis_training_id', $jenis->id)
        ...
        return view('pages.Training.mandatory', compact('trainings', 'jenis', 'pageTitle', 'heroTitle', 'description', 'breadcrumbItems', 'routeName'));
    }

    public function mandatory(Request $request)
    {
        $jenis = JenisTraining::where('code', 'MD')->firstOrFail();
    ...
    {
        $jenis = JenisTraining::where('code', 'LS')->firstOrFail();
