...
let Input_firnd_1 = "SertifikatPenghargaan.png";
let Input_firnd_2 = "SertifikatPenghargaan.png";
let Input_firnd_3 = "SertifikatPenghargaan.png";
let Input_firnd_4 = "SertifikatPenghargaan.png";
let Input_firnd_5 = "SertifikatPenghargaan.png";
let Input_firnd_6 = "SertifikatPenghargaan.png";
let Input_firnd_7 = "SertifikatPenghargaan.png";
let Input_firnd_8 = "SertifikatPenghargaan.png";
let Input_firnd_9 = "SertifikatPenghargaan.png";


let Input_post_img_1 = "SertifikatPenghargaan.png";
let Input_post_img_2 = "SertifikatPenghargaan.png";
let Input_post_img_3 = "SertifikatPenghargaan.png";
let Input_post_img_4 = "SertifikatPenghargaan.png";
let Input_post_img_5 = "SertifikatPenghargaan.png";
let Input_post_img_6 = "SertifikatPenghargaan.png";
let Input_post_img_7 = "SertifikatPenghargaan.png";
let Input_post_img_8 = "SertifikatPenghargaan.png";
let Input_post_img_9 = "SertifikatPenghargaan.png";
let Input_post_img_10 = "SertifikatPenghargaan.png";
let Input_post_img_11 = "SertifikatPenghargaan.png";
let Input_post_img_12 = "SertifikatPenghargaan.png";
...
let sertifikat_img_1 = document.querySelectorAll("#sertifikat-image-1");
let sertifikat_img_2 = document.querySelectorAll("#sertifikat-image-2");
let sertifikat_img_3 = document.querySelectorAll("#sertifikat-image-3");
let sertifikat_img_4 = document.querySelectorAll("#sertifikat-image-4");
let sertifikat_img_5 = document.querySelectorAll("#sertifikat-image-5");
let sertifikat_img_6 = document.querySelectorAll("#sertifikat-image-6");
let sertifikat_img_7 = document.querySelectorAll("#sertifikat-image-7");
let sertifikat_img_8 = document.querySelectorAll("#sertifikat-image-8");
let sertifikat_img_9 = document.querySelectorAll("#sertifikat-image-9");
...
for (let i = 0; i < sertifikat_img_1.length; i++) {
	sertifikat_img_1[i].src = Input_firnd_1;
		sertifikat_img_1[i].target = "frind";
}
for (let i = 0; i < sertifikat_img_2.length; i++) {
	sertifikat_img_2[i].src = Input_firnd_2;
		sertifikat_img_2[i].target = "frind";
}
for (let i = 0; i < sertifikat_img_3.length; i++) {
	sertifikat_img_3[i].src = Input_firnd_3;
		sertifikat_img_3[i].target = "frind";
}
for (let i = 0; i < sertifikat_img_4.length; i++) {
	sertifikat_img_4[i].src = Input_firnd_4;
		sertifikat_img_4[i].target = "frind";
}
for (let i = 0; i < sertifikat_img_5.length; i++) {
	sertifikat_img_5[i].src = Input_firnd_5;
		sertifikat_img_5[i].target = "frind";
}
for (let i = 0; i < sertifikat_img_6.length; i++) {
	sertifikat_img_6[i].src = Input_firnd_6;
		sertifikat_img_6[i].target = "frind";
}
for (let i = 0; i < sertifikat_img_7.length; i++) {
	sertifikat_img_7[i].src = Input_firnd_7;
		sertifikat_img_7[i].target = "frind";
}
for (let i = 0; i < sertifikat_img_8.length; i++) {
	sertifikat_img_8[i].src = Input_firnd_8;
		sertifikat_img_8[i].target = "frind";
}
for (let i = 0; i < sertifikat_img_9.length; i++) {
	sertifikat_img_9[i].src = Input_firnd_9;
		sertifikat_img_9[i].target = "frind";
}
