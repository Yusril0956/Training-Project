<aside class="navbar navbar-vertical navbar-expand-lg" data-bs-theme="dark" x-data="{
    collapsed: false,
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu" x-show="!collapsed" x-transition>
            <ul class="navbar-nav pt-lg-3">
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('training.index') }}" wire:navigate>
                        <span
