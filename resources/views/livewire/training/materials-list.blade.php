                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between">
                                <a href="{{ $material->url }}" target="_blank" class="btn btn-sm btn-primary">Lihat
                                    Materi</a>
                                @can('manage-training')
                                    <button wire:click="deleteMaterial({{ $material->id }})" class="btn btn-sm btn-danger">Hapus</button>
                                @endcan
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <form wire:submit.prevent="uploadMaterial" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" wire:model="url" class="form-control mt-2" placeholder="https://...">
                        </div>
                        <div class="text-end">
