...
@push('styles')
    <style>
        .alert-fixed-top-right {
            ...
            min-width: 300px;
            margin-top: 33px;
            background: #4a5568 !important; /* Darker gray for better contrast */
            z-index: 1055;
            box-shadow: 0 2px 12px rgba(0, 0, 0, 0.25);
            transition: opacity 0.5s ease-in-out;
            opacity: 1;
            color: #151718ff; /* Light text */
        }
        ...
        .section-icon {
            ...
            background: #bee3f8; /* soft blue background */
            color: #2c5282; /* blue icon color */
        }
        ...
        /* Subtle animations */
        .settings-card, .role-badge, .action-button .btn {
