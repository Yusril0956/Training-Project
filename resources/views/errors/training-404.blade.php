...
<body class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4">
    <div class="text-center max-w-md w-full fade-in">
        <!-- 404 Heading -->
        <h1
            class="text-8xl md:text-9xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 mb-4 bounce-animation">
            404
        </h1>
        ...
        <div class="gif-placeholder rounded-2xl w-64 h-45 mx-auto mb-8 flex items-center justify-center shadow-lg">
            <div class="text-center">
                <img src="{{ asset('404.gif') }}" width="350" height="220" alt="Tabler" loading="lazy">
        ...
        (function() {
            function c() {
                ...
                if (b) {
                    ...
                    d.innerHTML =
                        "window.__CF$cv$params={r:'9782f2e8d2bfce5f',t:'MTc1NjcxMDYzNy4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";
